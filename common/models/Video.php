    ...
    public function behaviors()
{
    ...
    public function rules()
    {
        return [
            ...
            [['description'], 'string'],
            [['status', 'has_thumbnail', 'updated_at', 'created_at', 'created_by'], 'integer'],
    ...
    */
    ...
    public function save($runValidation = true, $attributeNames = null)
    {
        ...
        if ($isInsert) {
            ...
            if($this->thumbnail){
                $thumbnailPath = Yii::getAlias('@frontend/web/storage/thumbs/' . $this->video_id . '.jpeg');
    ...
    public function getThumbnailLink() {
        ...
        Yii::$app->params['frontendUrl'] . 'storage/thumbs/' . $this->video_id . '.jpeg'
        : '';
    }
