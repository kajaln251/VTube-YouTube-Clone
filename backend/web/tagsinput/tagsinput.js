...
(function ($) {
    ...
    TagsInput.prototype = {
      ...
      /**
       * Adds the given item as a new tag. Pass true to don'tPushVal to prevent
      ...
      add: function(item, dontPushVal, options) {
        ...
        // If using type ahead, once the tag has been added, clear the typeahead value so it does not stick around in the input.
